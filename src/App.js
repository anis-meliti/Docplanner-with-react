...
function App() {
  ...
  </svg>, <svg xmlns="http://www.w3.org/2000/svg" width="167" height="32" viewBox="0 0 167 32">
    <path
  ...
  </svg>, <svg xmlns="http://www.w3.org/2000/svg" width="182" height="32" viewBox="0 0 182 32">
    <path
  ...
  </svg>, <svg xmlns="http://www.w3.org/2000/svg" width="220" height="32" viewBox="0 0 220 32">
    <path
  ...
  </svg>, <svg xmlns="http://www.w3.org/2000/svg" width="195" height="32" viewBox="0 0 195 32">
    <path
  ...
  return (
    <div>
      ...
      <Container className="statis-div">
        <Col md={{ span: 4, offset: 2 }} className="primary-dev">
          <Row  >
            <p className='stat-title'>The world's<br />
              biggest healthcare platform
          </p>
          </Row>
          <Row >
            <Col className="statis-desc"> We work from 6 offices all over the world,
               bringing Docplanner Group to
